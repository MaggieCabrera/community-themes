...
<div class="wp-block-column has-custom-black-background-color has-background" style="padding-top:2px;padding-right:2px;padding-bottom:2px;padding-left:2px"><!-- wp:group {"style":{"border":{"radius":"4px"},"dimensions":{"minHeight":"100%"},"spacing":{"padding":{"right":"var:preset|spacing|80","left":"var:preset|spacing|80"}}},"backgroundColor":"custom-beige","layout":{"type":"flex","orientation":"vertical","verticalAlignment":"center"}} -->
<div class="wp-block-group has-custom-beige-background-color has-background" style="border-radius:4px;min-height:100%;padding-right:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)"><!-- wp:paragraph -->
...
<div class="wp-block-column" style="border-width:2px"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Joel_Gavins.jpg","dimRatio":0,"minHeight":640,"minHeightUnit":"px","isDark":false,"style":{"border":{"radius":"4px"}}} -->
<div class="wp-block-cover is-light" style="border-radius:4px;min-height:640px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Joel_Gavins.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","fontSize":"large"} -->
